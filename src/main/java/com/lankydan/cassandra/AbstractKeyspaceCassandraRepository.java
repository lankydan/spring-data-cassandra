...
// should some of this code be moved to an AbstractKeyspaceCassandraRepository? Does it need to be
...
// the AbstractKeyspaceCassandraRepository without exposing a lot of the logic that is normally
...
public abstract class AbstractKeyspaceCassandraRepository<T, ID>
  ...
  public AbstractKeyspaceCassandraRepository(
